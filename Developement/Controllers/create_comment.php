...
echo json_encode(['user_name'=>$getcomment[0]['user_name'],'specialist_name'=>$getcomment[0]['specialist_name'],'dates'=>$getcomment[0]['dates'],'times'=>$getcomment[0]['times'],'comment_text'=>$getcomment[0]['comment_text'],'comments_number'=>$number['number'],'answer_rate'=>$number_of_answers]);
?>
