  ...
  <div class="row">
    <div class="col-lg-8 col-sm-12">
      <div class="container">
        ...
        $posts=post::search_post(" ","s");
        else
        $posts=post::search_post($_GET['question'],"s");
        foreach ($posts as $post) {
          $n=comment::get_number_comments($post["post_id"]);
          ?>
        <div class="card mb-3 filterDiv <?php echo $post["language"];?> <?php if($n['number']==0) echo "unsolved"; ?>">
          ...
          <div class="card-body">
            ...
            <!-- comments forms -->
            <form class="formC<?php echo $post['post_id'] ?>" action="" method="post">
          ...
          <div class="divA<?php echo $post['post_id'] ?>" style="display:none"; >
            ...
            <div class="card mb-3 ml-5">
              ...
              <div class="card-header">
                ...
                else echo $comment['specialist_name'] ?>
              </div>
              <div class="col-lg-4">
                <img src="img/calender.png" width="20 px">
        ...
        encode          : true
          ...
          $(".divA<?php echo $post['post_id'] ?>").prepend("<div class='card mb-3 ml-5'><div class='card-header'><div class='row'><div class='col-lg-4'> <img src='img/profile.png' width='30 px'>  "+data['specialist_name']+"   </div>                <div class='col-lg-4'>    <img src='img/calender.png' width='20 px'> "+ data['dates'] +"   </div>    <div class='col-lg-4'> <img src='img/time.png' width='20 px'>     " +data['times']+"        </div> </div>     </div>     <div class='card-body'>   <p class='card-text'>"+data['comment_text']);
          $("#number_<?php echo $post["post_id"] ?>").html(data['comments_number']);
          $("#answer_rate").html(data['answer_rate']);
          });
        });
    ...
    <div class="col-lg-4 col-sm-12">
        ...
        <div class="container">
          <div class="jumbotron">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <button type="button" class="btn btn-outline-dark btn-lg btn-block " onclick="filterSelection('unsolved')"><br>Unsolved</button>
              </div>
            </div>
          </div>
        </div>
        <div class="container">
          <div class="jumbotron">
            ...
            <span style="font-size:35px; font-weight:bold;"><span style="color:#5f6bdd;">C</span>ode<span style="color:#5f6bdd;">G</span>uide</span>
            <hr class="lead">
            <h5>Your balance: <span class="badge badge-success"> <?php echo specialist::show_my_money($_SESSION['specialist_id']) ?></span> $</h3>
            <h5>You answered <span id = "answer_rate" class="badge badge-info"><?php echo specialist::show_answer_rate($_SESSION['specialist_id']) ?></span> questions</h3>
          </div>
        </div>
      </div>
  </div>
