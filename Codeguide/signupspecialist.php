    ...
    <script>
      $(document).ready(function(){
          ...
          if($("#language").val()=="Choose..."){
            var warning = $("<div class='mt-2 alert alert-danger' role='alert'>You must choose your field of expertise</div>");
            $(this).after(warning);
            warning.slideUp(2000);
            return false;
          }
            ...
            <form action="" method="post">
              ...
              <div class="input-group mb-4">
                <div class="input-group-prepend">
                  <label class="input-group-text" for="inputGroupSelect01">Choose your field of expertise</label>
                </div>
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Enter your accomplishments in this field</label>
